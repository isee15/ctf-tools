...
public class UsbKeyboardDataHacker {
    private static String normalKeys = "{\"04\": \"a\", \"05\": \"b\", \"06\": \"c\", \"07\": \"d\", \"08\": \"e\", \"09\": \"f\", \"0a\": \"g\", \"0b\": \"h\", \"0c\": \"i\",\n" +
    ...
    private static String shiftKeys = "{\"04\": \"A\", \"05\": \"B\", \"06\": \"C\", \"07\": \"D\", \"08\": \"E\", \"09\": \"F\", \"0a\": \"G\", \"0b\": \"H\", \"0c\": \"I\",\n" +
            "             \"0d\": \"J\", \"0e\": \"K\", \"0f\": \"L\", \"10\": \"M\", \"11\": \"N\", \"12\": \"O\", \"13\": \"P\", \"14\": \"Q\", \"15\": \"R\",\n" +
            ...
            packets.forEach(packet -> {
                ...
                if (bytes[23] == 0x08 && bytes[24] == 0 && bytes[25] == 0 && bytes[26] == 0) {
                    ...
                    if (bytes.length >= 8) {
                        ...
                        } else if ((bytes[start + 0] & 0b10) > 0 || (bytes[start + 0] & 0b100000) > 0) {
                            String hex2 = String.format("%02x", bytes[start + 2]);
                            if (bytes[start + 2] != 0 && normalKeysMap.containsKey(hex2)) {
                                result.append(shiftKeysMap.get(hex2));
                            }
                        } else {
                            System.out.println("[-] Unknow Key :" + bytes[start + 0]);
                        }
                    }
                    sb.append("\n");
                }
